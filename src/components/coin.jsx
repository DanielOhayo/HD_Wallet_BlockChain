...
export default function Coin({ sym, val, cb }) {
    ...
    return (
        <>
            <div class="grid grid-cols-2 gap-1 text-gray-400 text-xs border-b-2 border-gray-200 pt-2 pb-2 mb-0 mt-0 pl-2 hover:bg-gray-200 cursor-pointer" 
            onClick={() => cb(sym)}>
                <div class="flex justify-start gap-3">
                    ...
                    <div>
                        ...
                        {state.tickers && <div class="flex justify-start gap-1 whitespace-nowrap">
                            <div class="text-gray-600">$</div>
                            <div class="text-gray-600">{price(state,sym)}</div>
                            <div class={"font-bold " + change(state,sym).color}>{change(state,sym).change}</div>
                        </div>}
                    </div>
                </div>
                <div class="flex justify-between">
                    {
                        state.testnet && state.balances ? <div>
